...
VALUES (1, now(), now(), 30, '1990-01-01', 'admin@company.com', '1', 'admin', '1.1.1.1', '13800138000', 'admin', '$2a$10$6/Kqyc16VJHvQQJAAfZQeOnGX1dISWqQfTgVHAM00aOqRjHgbl2Oa', 'admin',0);
-- 内置普通用户（测试）--
INSERT INTO au_user (id, create_date, modify_date, age, birthday, email, enable_status, login_id, login_ip, mobile, nickname, password, username,version)
VALUES (2, now(), now(), 30, '1990-01-01', 'test@company.com', '1', 'test', '1.1.1.1', '13800138000', 'test', '$2a$10$8zPhZE9L0Nflca5su/WV0.LioSd3WLUKqpVQhGyi00n2NsJr48M52', 'test',0);
