...
public class QuartzUtils {
     ...
     */
    public static void addJob(Scheduler scheduler, String jobName, String jobGroupName, String triggerName, String triggerGroupName, Class jobClass,
        String cron,
        Object... objects) {
        try {
            // 任务名，任务组，任务执行类
     ...
     */
    public static void modifyJobTime(Scheduler scheduler, String jobName, String jobGroupName, String triggerName, String triggerGroupName,
        String cron) {
        try {
     ...
     * @param jobGroupName group name
     */
    public static void triggerJob(Scheduler scheduler, String jobName, String jobGroupName) {
        try {
            JobKey key = new JobKey(jobName, jobGroupName);
     ...
     * @return 检查结果
     */
    public static boolean checkExists(Scheduler scheduler, String jobName, String jobGroupName) {
        try {
            JobKey key = new JobKey(jobName, jobGroupName);
